 <header>
        <div>
				...
				<ul class="sf-menu">
					<li>
						<a href="../../../crudedit/cart/index.php">Home</a>
						<div class="mobnav-subarrow"><i class="fa fa-plus"></i></div>
						<ul>
							<li><a href="../../../crudedit/cart/index.php">Home</a></li>

						</ul>
					</li>
					<li>
						<a href="../../../crudedit/cart/shop.php">Shop</a>
						<div class="mobnav-subarrow"><i class="fa fa-plus"></i></div>
						<ul>
							<li><a href="../../../crudedit/cart/shop.php">Jerseys</a></li>
							<li><a href="shop.php">Tickets</a></li>
<!--<img src="../../cart/shop.php"  http://localhost:8080/crudedit/cart/index.php-->
						</ul>
					</li>
					<li>
						<a href="#">My Account</a>
						<div class="mobnav-subarrow"><i class="fa fa-plus"></i></div>
						<ul>
							<li><a href="../../../crudedit/cart/my-account.php">My Orders</a></li>
				...
				<div class="header-xtra">
					<div class="s-cart">
						...
						<div class="cart-info">
							...
							<div class="ci-total">Subtotal: €400.00</div>
							<div class="cart-btn">
								<a href="#">View Bag</a>
								<a href="#">Checkout</a>
							</div>
