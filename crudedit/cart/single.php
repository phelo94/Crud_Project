...
if(isset($_GET['id']) & !empty($_GET['id'])){
    //define the id to resolve line error 18
	$id = $_GET['id'];
			...
			<?php if(isset($smsg)){ ?><div class="alert alert-success" role="alert"> <?php echo $smsg; ?> </div><?php } ?>
					<div class="row">
						...
						<div class="col-md-7 product-single">
							...
							<div class="p-price">INR <?php echo $prodr['price']; ?></div>
							...
							<!--  $prodrsql = "SELECT * FROM category WHERE id={£prodr['catid']}"; ,,,  not working -->
								<span>Categories: 
								<?php 
					...
					<div class="related-products">
						...
						<div class="row">
							...
							<?php
                               ...
                               how to rand the data from products to get others to buy 
                               */
