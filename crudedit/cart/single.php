				...
				<div class="row">
					...
					<div class="row">
						<div class="col-md-5">
							<div class="gal-wrap">
								<div id="gal-slider" class="flexslider">
									<ul class="slides">
										<li><img src="./images/jersey.jpeg" class="img-responsive" alt=""/></li>
						...
						<div class="col-md-7 product-single">
							<h2 class="product-single-title no-margin">Jersey</h2>
							<div class="space10"></div>
							<div class="p-price">&euro;199.99</div>
							<p>Description of item, Description of item, Description of item, Description of item, Description of item, Description of item, Description of item, </p>
							...
							<div class="product-meta">
								<span>Categories: <a href="#">Jersey</a>, <a href="#">Sport</a>, <a href="#">Equipment</a></span><br>
								<span>Tags: <a href="#">Yellow</a>, <a href="#">Size</a></span>
							</div>
						</div>
					</div>
								...
								<div class="sm-item isotope-item">
									<div class="product">
										<div class="product-thumb">
											<img src="./images/jersey2.jpeg" class="img-responsive" width="200" height="150" alt="">
										...
										<h2 class="product-title"><a href="#">Jersey</a></h2>
