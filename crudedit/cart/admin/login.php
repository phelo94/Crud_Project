...
<!DOCTYPE html>	
	...
	<title>Waterford FC | Admin Login</title>
...
<!-- HEADER -->
	<header id="header2">
		<div class="container">
			<div class="row">
				<div class="col-md-3 col-xs-5 col-offset-4 logo">
					<a href="index.php"><img src="../images/crest.png" class="img-responsive" width="120" height="120" alt=""/></a>
				</div>
	...
	<section id="content">
		<div class="content-blog">
			<div class="container">
				...
				<?php if(isset($fmsg)){ ?><div class="alert alert-danger" role="alert"> <?php 
                            echo $fmsg; ?> </div><?php } ?>
