...
<?php include("../scripts/view_user.php") ?>
...
<div class="jumbotron jumbo" style="background-color:#74b5f7;">
    <h2 class="text-center" style="font-size:70px; font-weight: 400;">Welcome <?php echo $_SESSION['firstname']; ?></h2>
    <h4 class="text-center" style="font-size: 30px;"></h4>
</div>
